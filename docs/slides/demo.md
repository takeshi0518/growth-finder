...
基本動作 / バリスタ / キャッシャーの 3 セクションを
スキル / ホスピタリティ / クレンリネスの３軸で評価を記録・可視化させます
...
前提: LLM は店長の評価を書き換えない。
過去との比較・要約に徹させ、面談の土台を作る。
...
判断(評価): 店長…現場の空気感は人にしか分からない
整形(要約する): LLM…店長の評価を面談の土台へ
